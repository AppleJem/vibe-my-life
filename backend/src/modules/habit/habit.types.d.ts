...
export interface Habit {
   ...
   * section is a client-side filter over the same list query everything else reads — and
   * deleting or archiving a habit can never leave a dangling training entry.
   */
  training?: boolean
}
