interface TextAreaInputProps {
  ...
  rows?: number
  /**
   * On by default, because in the add-expense wizard this field *is* the step. A form
   * that shows every field at once passes `false` — grabbing focus there would scroll
   * the page to whichever textarea happened to mount last.
   */
  autoFocus?: boolean
}
